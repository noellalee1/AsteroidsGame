...
public void draw()
{
  ...
  if (paused == false) {
    ...
    for (int i = 0; i < rock.size(); i++) {
      rock.get(i).move();
      rock.get(i).show();
      float f = dist(bob.getX(), bob.getY(), rock.get(i).getXrock(), rock.get(i).getYrock());
    ...
    for (int j = 0; j < rock.size(); j++) {
      for (int i = 0; i < shot.size(); i++) {
        float f = dist(shot.get(i).getXshot(), shot.get(i).getYshot(), rock.get(j).getXrock(), rock.get(j).getYrock());
